...
export const { useGetIncompleteTaskListQuery, useClaimTaskRewardsMutation, useCreateTaskAdminMutation, useGetAllTaskAdminQuery, useDeleteTaskAdminMutation, useUpdateTaskAdminMutation } = TaskEndpoint;