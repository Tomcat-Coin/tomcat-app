                ...
                <div className="w-full bg-white bg-opacity-10 backdrop-blur-2xl min-h-[85vh] rounded-t-3xl relative overflow-hidden border-t border-white">
                    <div className={`${isLoading && 'hidden'} h-16 mt-0 rounded-2xl flex items-center gap-3 px-3 overflow-hidden absolute top-0 w-full bg-white bg-opacity-10`}>
                        ...
                        <div className="">
                            ...
                            <p className="font-roboto text-xs text-[#999999]">{Number(data?.data[0]?.User?.point).toFixed(2)} <strong>TOMS</strong></p>
                        </div>
                    </div>
                                        ...
                                        <div key={index} className={`h-16 mt-0 rounded-2xl flex items-center gap-3 px-3 overflow-hidden w-full`}>
                                            ...
                                            <div className="flex justify-between items-center ">
                                                <div className="">
                                                    ...
                                                    <p className="font-roboto text-xs text-[#999999]">{Number(item?.point).toFixed(0)} <strong>TOMS</strong></p>
                                                </div>
